...
IMPL_PROPERTY_TYPE_EX(std::string, PROPERTY_TYPE_STRING, PROPERTY_FLAG_IS_COMPLEX | PROPERTY_FLAG_IS_NOT_VALUE_TYPE, 0, 0)
...
IMPL_PROPERTY_TYPE_EX(AudioClip*, PROPERTY_TYPE_ASSET_REF, PROPERTY_FLAG_IS_COMPLEX, ASSET_TYPE_AUDIO_CLIP, 0)
